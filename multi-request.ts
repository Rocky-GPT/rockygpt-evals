...
const result = await answerQuestion({
  message: 'What time does the library close, and what is the Registrar phone number?',
...
check(failures, 'reply addresses the library', normalized.includes('library'), result.answer);
